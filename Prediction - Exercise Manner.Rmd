---
title: "Predition Models: Quality of Exercising"
...
We use random forest to fiot our model. 
...
## Model Validation
The model was validated showing the following accuraccy measurements:
...
## Run Predition
Considering the high level of accuraccy we used this model to predict the test data set.Results of the prediction are show here:
...
## Summary
This exercise goes through all steps of fitting a predictive model. Creating models with the data set proved very computational intensive. I was surprised  of the high accuraccy resulted out of just one model.  
